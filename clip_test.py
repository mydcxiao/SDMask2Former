...
text = open_clip.tokenize("The sun dipped below the horizon, casting a warm glow across the tranquil ocean. As the waves gently lapped the shore, a sense of serenity settled over the beach, creating a perfect moment of peace and beauty.")
print(text)
text_ = text[..., :20]
if text.argmax(dim=-1).item() >= 20:
    text_[..., -1] = text[..., text.argmax(dim=-1)]
print(text_)
text = text_
# print(open_clip.tokenize("<|endoftext|>"))

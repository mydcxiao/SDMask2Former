...
def get_parser():
    ...
    parser.add_argument('--warmup', default=500, type=int, help='warmup iterations')
    parser.add_argument('--wd', '--weight-decay', default=0.01, type=float, metavar='W', help='weight decay',
                        dest='weight_decay')
